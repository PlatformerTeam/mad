...
namespace mad::core {
    ...
    Entity::Id EntityStorage::create_physical_entity(int z_ind, Vec2d initial_position, float initial_rotation, std::shared_ptr<Image> image,
        ...
        m_map_entities[new_entity_id] = std::make_unique<PhysicalEntity>(new_entity_id, z_ind, initial_position, initial_rotation,
                                                                         image, physicalWorld, is_fixed, is_rotated);
        return new_entity_id;
    }
